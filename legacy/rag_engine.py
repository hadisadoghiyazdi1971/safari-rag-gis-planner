...
class RAGEngine:
    ...
    def _merge_data(self) -> List[Dict]:
        """Merge Excel and image processing data with correct column names"""
        merged_data = []
        
        for i, filename in enumerate(self.npz_data['filenames']):
            # Find corresponding row in Excel - with actual column name 'File Name'
